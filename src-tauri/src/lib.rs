...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::discover::preview_copy_project_skills,
            commands::discover::execute_copy_project_skills,
            commands::discover::get_project_platform_dirs,
            commands::discover::preview_install_collection_to_project,
            commands::discover::execute_install_collection_to_project,
            commands::discover::preview_add_discovered_skill_to_collection,
            commands::discover::execute_add_discovered_skill_to_collection,
            commands::discover::batch_add_discovered_skills_to_collections,
            commands::discover::delete_discovered_skill_permanently,
