...
import { CollectionInstallProjectDialog } from "@/components/collection/CollectionInstallProjectDialog";
                ...
                <div className="flex items-center justify-between px-6 py-3 border-b border-border">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <span>{t("collection.installToProject")}</span>
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
      ...
      {currentDetail && (
        <>
          ...
          <CollectionInstallProjectDialog
            ...
            collectionName={currentDetail.name}
            onComplete={() => void loadCollections()}
          />
        </>
      )}
